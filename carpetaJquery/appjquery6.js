$(document).ready(function() {
    ...
    $.ajax({
        url: "http://localhost/tp2jquery/consultasBD.php?paises=1",
        type: "GET",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function(data) {
    ...
    $("#mostrarPaises").on("change", function() {
        console.log(document.getElementById("mostrarPaises").value);
        $.ajax("http://localhost/tp2jquery/consultasBD.php?estados=" +
            document.getElementById("mostrarPaises").value, {
                // url: "http://localhost/tp2jquery/consultasBD.php?estados=" +
                //     document.getElementById("mostrarPaises").value,
                // type: "GET",
                // contentType: "application/json; charset=utf-8",
                // dataType: "json",
